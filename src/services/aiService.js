...
export async function processAI({ client, from, message, history, userEmail, language, activeIntent = null, activeOrderType = null, isNewUser = false, userName = null, selectedServiceName = null }) {
